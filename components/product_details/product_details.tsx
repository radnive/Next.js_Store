...
const ProductDetails: FC<ProductDetailsProps> = ({product}) => {
  ...
  useEffect(() => {
    ...
    tl?.fromTo('#product_details__outside_buttons',
      {
        y: '100%'
      },
      {
  ...
  return (
    <>
        ...
        <div className={styles.details_container}>
          <div className={styles.details}>
            ...
            <footer ref={footerRef}>
              ...
              <div className={styles.buttons} data-button-type='inside'>
      ...
      <div id='product_details__outside_buttons' className={styles.buttons} data-button-type='outside'>
        <button className={styles.buttons__purchase}>
          { intl.formatMessage({ id: 'button.purchase.text' }) }
          <b>${ product.price }</b>
        </button>
